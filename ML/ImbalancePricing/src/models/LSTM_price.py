...
# Convert SettlementDate and StartTime to datetime for better plotting
...
# Create time-series plots for train_1 dataset
fig, axs = plt.subplots(3, 1, figsize=(15, 15), sharex=True)

# Plot System Sell and Buy Prices
...
# Plot Total Accepted Offer and Bid Volumes
...
# Load the training data from all five files
train_files = [
...
# Select the relevant feature for forecasting (e.g., SystemSellPrice)
...
# Combine train and test data for LSTM
...
# Create training datasets for LSTM
time_step = 10
...
# Adjust the length of the test series to match the length of the test predictions
...
# Plot actual vs predicted scatter plot with a reference line
